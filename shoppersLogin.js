...
const SHOPPERS_PREFIX = "shoppers_";
  ...
  document.getElementById("createAccountPopup").addEventListener("submit", function(e) {
    ...
    const users = JSON.parse(localStorage.getItem(SHOPPERS_PREFIX + "users")) || [];
    ...
    localStorage.setItem(SHOPPERS_PREFIX + "users", JSON.stringify(users));
  ...
  document.getElementById("login").addEventListener("submit", function(e) {
    ...
    location.href = 'shoppersPage.html';
  });
